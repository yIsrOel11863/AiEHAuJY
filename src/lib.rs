...
#[derive(Debug)]
pub struct NexusDevProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NexusDevProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NexusDev processing");
    
    let mut processor = NexusDevProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NexusDevProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NexusDevProcessor::new(false);
